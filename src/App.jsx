...
function App() {
  ...
  return (
    <>
      ...
      ></span>
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']" data-scroll-container>
        {showCanvas &&
          data[0].map((canvasdets, index) => (
            <Canvas key={`canvas-${index}-${canvasdets.startIndex}`} details={canvasdets} />
          ))}
        <div className="w-full relative z-[1] h-screen ">
          ...
          <div className="w-full bottom-0 left-0 mt-28">
            <h1
              ref={headingref}
